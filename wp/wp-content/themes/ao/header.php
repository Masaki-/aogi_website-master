...
<title><?php echo $label_obj->labels->name;?><?php title_keni(); ?></title>
...
fbq('init', '1792942657590282', {
em: 'insert_email_variable,'
});
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1792942657590282&ev=PageView&noscript=1"
/></noscript>
<!-- DO NOT MODIFY -->
...
<!--    <li><a href="<?php bloginfo('url'); ?>/aboutus" title="AO義塾とは About AOGIJUKU">AO義塾について<span class="english_title">About&amp;Concept</span></a></li> -->
    <li><a href="<?php bloginfo('url'); ?>/feature" title="AO義塾の特徴･仕組み">AO義塾の特徴･仕組み<span class="english_title">System</span></a></li>
		<li><a href="<?php bloginfo('url'); ?>/aogi-curriculum">カリキュラム･大学別案内<span class="english_title">Curriculum</span></a></li>
    ...
    <li><a href="<?php bloginfo('url'); ?>/results" title="合格実績･卒業生の声 Result">合格実績･卒業生の声<span class="english_title">Result&amp;Voice</span></a></li>
		<li><a href="<?php bloginfo('url'); ?>/howto" title="AO入試とは">AO入試の基礎知識<span class="english_title">AO Examination</span></a></li>
...
<img src="<?php bloginfo('template_url'); ?>/images/common/sp_g_nav_logo.png" width="108" alt="AO義塾 志を実現するためのAO入試専門塾"></a>
	</div>
	<div id="map_nav">
		<a href="<?php bloginfo('url'); ?>/school">
<img src="<?php bloginfo('template_url'); ?>/images/school-map.png" width="108" alt="教室の場所"></a>
        </div>
	<div id="menu_button">
		<span class="nav_icon"></span>
	</div>
...
<li><a href="<?php bloginfo('url'); ?>/aogi-curriculum">カリキュラム･大学別案内</a></li>
<li><a href="<?php bloginfo('url'); ?>/ao">AO入試の基礎知識</a></li>
...
-->
	<!--<ul>
		<li style="width:400px;"><a class="btnfckheader" href="http://aogijuku.com/2015opencampus" title="全授業無料オープンキャンパス">【お知らせ】★全授業無料キャンペーン実施中(2015年12月まで)</a></li>
	...
	<div class="header_cv">
		<div class="header_cv_inner" class="clearfix">
			...
			<div class="header_cv_freetrial">
				<a href="<?php bloginfo('url'); ?>/entry?page=<?php echo $kousya;?>" title="無料AO・推薦相談/体験申込"><!-- <img src="<?php bloginfo('template_url'); ?>/img/common/header_mail.png" alt="メールアイコン"> -->無料相談/体験申込</a>
			</div>
		</div>
	</div>
*/ ?>
